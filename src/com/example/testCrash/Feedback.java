...
//    }
    ...
    public static void sendEmail3(Context context, String email, String subject, String body) {
...
//    addAppInfoTo(body, activity,packageName);
        ...
        sendEmail(activity,  "Send Feedback", subject, body.toString());
    }
}
